...
function createcontractTemplate(e) {
	...
	aTag.href = '../html/contract_template.html';
	liTag.textContent = 'Templates';
	aTag.appendChild(liTag);
	liTag.id = 'contract_templates';

	//ulTag.appendChild(liTag);
	contractstab.appendChild(aTag);

	contracttemplatetab = document.getElementById('contract_templates');
	contracttemplatetab.addEventListener('click', function () {
		// console.log('hellow');
		window.location.replace('../html/contract_template.html');
	});
}
